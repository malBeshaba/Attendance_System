...
<template>
    <div class="calendar">
            ...
            <div class="calendar-info" @click.stop="changeYear">
                ...
                <div class="month">
                    <div class="month-inner" :style="{'top':-(this.month*20)+'px'}">
                        <span v-bind:v-for="m in months">{{m}}</span>
                    </div>
                </div>
        ...
        <thead>
            <tr>
                <td v-bind:v-for="week in weeks" class="week">{{week}}</td>
            </tr>
        </thead>
        <tbody>
        <tr v-bind:v-for="(day,k1) in days" style="{'animation-delay',(k1*30)+'ms'}">
            <td v-bind:v-for="(child,k2) in day" :class="{'selected':child.selected,'disabled':child.disabled}" @click="select(k1,k2,$event)">
        ...
        <div class="calendar-years" :class="{'show':yearsShow}">
            <span v-bind:v-for="y in years" @click.stop="selectYear(y)" :class="{'active':y==year}">{{y}}</span>
        </div>
